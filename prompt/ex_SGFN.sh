...
# SGFN
#run_command train redu60_epoch110_gcn_sgfn gcn ./config/SGFN.json 0 0 x
run_command eval eval_redu60_st05_gcn_sgfn gcn ./config/SGFN.json 0.05 0 /home/oi/Desktop/song/lightweight_3DSSG/config/ckp/SGFN/redu60_epoch110_gcn_sgfn
...
# # attn+SGFN
#run_command train redu60_epoch120_gcn_attn_sgfn gcn ./config/attn_SGFN.json 0 0 x
